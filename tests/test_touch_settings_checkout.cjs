...
const ctx={repriceVariantCart(){},cart:new Map([['1',{qty:2,price:100}]]),checkoutSettings:{tax_enabled:true,tax_rate:5},document:{querySelector:s=>({value:s==='#checkoutDiscount'?'20':'189'})}};
