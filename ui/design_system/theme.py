...
class ThemeColors:
    ...
    # Scrollbar
    scrollbar_bg: str = "#f2f3f6"
    scrollbar_handle: str = "#8f8f8f"
    scrollbar_handle_hover: str = "#5865F2"

@dataclass
class DarkThemeColors:
    """Dark theme color palette"""
    primary: str = "#7482f5"
    primary_hover: str = "#8896ff"
    primary_active: str = "#6576e8"
    primary_light: str = "#384060"
    primary_dark: str = "#242a34"
    
    success: str = "#4fdbad"
    success_hover: str = "#39c698"
    danger: str = "#ff8a96"
    danger_hover: str = "#f0707f"
    warning: str = "#ffc46b"
    warning_hover: str = "#efad4e"
    info: str = "#3498db"
    info_hover: str = "#2980b9"
    
    text: str = "#eef2f7"
    text_secondary: str = "#c8d0dc"
    text_muted: str = "#9fa9b8"
    text_light: str = "#ffffff"
    
    bg: str = "#262c36"
    bg_hover: str = "#343c4a"
    bg_active: str = "#3a4352"
    card_bg: str = "#2a303b"
    
    border: str = "#3d4655"
    border_hover: str = "#5f6b7f"
    border_focus: str = "#7482f5"
    
    input_bg: str = "#252b35"
    input_border: str = "#4d596c"
    input_focus: str = "#7482f5"
    
    table_header: str = "#262c36"
    table_alternate: str = "#262c36"
    table_selection: str = "#384060"
    
    progress_bg: str = "#7482f5"
    shadow: str = "rgba(0, 0, 0, 0.4)"
    
    scrollbar_bg: str = "#262c36"
    scrollbar_handle: str = "#9ea7b5"
    scrollbar_handle_hover: str = "#5865F2"
